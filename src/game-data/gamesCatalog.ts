...
export const GAMES_CATALOG: GameDefinition[] = [
  ...
  // creativity 분야
  {
    ...
    labelKo: '벽 퍼즐',
    labelEn: 'Wall Puzzle',
    descriptionKo: '벽을 피해 모든 칸을 한 번씩 지나는 한붓그리기 퍼즐',
    descriptionEn: 'One-stroke maze: visit every cell exactly once, avoiding walls',
    icon: '🧱',
    ...
    difficultySettings: {
      ...
      panelLabel: '난이도 선택',
      options: [
        { id: 'wall-tier-1', label: '입문' },
        { id: 'wall-tier-2', label: '초급' },
        { id: 'wall-tier-3', label: '중급' },
        { id: 'wall-tier-4', label: '고급' },
        { id: 'wall-tier-5', label: '심화' },
      ],
    },
  },
];
